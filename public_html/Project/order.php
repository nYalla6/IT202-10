...
if (isset($_POST["purchase"])) {
    ...
    if (!$hasError) {
        ...
        $db = getDB();
        $stmt = $db->prepare("INSERT INTO Orders (email, password, username) VALUES(:email, :password, :username)");
        try {
        ...
        <div class="card bg-white col-4">
            ...
            <form method="POST">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <label class="card-title col-3" for="country"><b>Country</b></label>
                    <select class="col-3" id="country" name="country">
